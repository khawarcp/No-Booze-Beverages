  ...
  updateQuantity(line, quantity, name) {
    ...
    fetch(`${routes.cart_change_url}`, { ...fetchConfig(), ...{ body } })
      ...
      .then((state) => {
        ...
        parsedState.item_count > 0 ? document.querySelector('.cart-main-wrapper').classList.remove('cart-no-item') : document.querySelector('.cart-main-wrapper').classList.add('cart-no-item') ;
